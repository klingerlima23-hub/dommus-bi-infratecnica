"""
Sincroniza d_equipe (origem bi_dommus -> destino dw_infratecnica.d_equipe).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em eq.id
        (alias id_equipe no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_equipe"
PK_QUALIFIED   = "eq.id"
PK_ALIAS       = "id_equipe"
CAMINHO_SQL    = caminho_sql("consulta_d_equipe")
