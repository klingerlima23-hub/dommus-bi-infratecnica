"""
Sincroniza f_oportunidade (origem bi_dommus -> destino dw_infratecnica.f_oportunidade).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em O.id_oportunidade
        (alias id_oportunidade no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_oportunidade"
PK_QUALIFIED   = "O.id_oportunidade"
PK_ALIAS       = "id_oportunidade"
CAMINHO_SQL    = caminho_sql("consulta_f_oportunidade")
