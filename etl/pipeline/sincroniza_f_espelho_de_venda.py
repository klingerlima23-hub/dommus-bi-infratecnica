"""
Sincroniza f_espelho_de_venda (origem bi_dommus -> destino dw_infratecnica.f_espelho_de_venda).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em tu.id
        (alias id_unidade no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_espelho_de_venda"
PK_QUALIFIED   = "tu.id"
PK_ALIAS       = "id_unidade"
CAMINHO_SQL    = caminho_sql("consulta_f_espelho_de_venda")
