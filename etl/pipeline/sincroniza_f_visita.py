"""
Sincroniza f_visita (origem bi_dommus -> destino dw_infratecnica.f_visita).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em oa.id_oportunidade_atendimento
        (alias id_visita no resultado).

A consulta de origem (consulta_f_visita.sql) nao possui WHERE com janela de
data, entao o full load carrega tudo e o construir_sql_paginado injeta o
WHERE de pagination automaticamente.
...
# ---------- parametros ----------
TABELA_DESTINO = "f_visita"
PK_QUALIFIED   = "oa.id_oportunidade_atendimento"
PK_ALIAS       = "id_visita"
CAMINHO_SQL    = caminho_sql("consulta_f_visita")
...
def main():
    ...
    sql_paginado = construir_sql_paginado(sql_raw, PK_QUALIFIED)
