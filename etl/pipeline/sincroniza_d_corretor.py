"""
Sincroniza d_corretor (origem bi_dommus -> destino dw_infratecnica.d_corretor).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em SG.id
        (alias id_corretor no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_corretor"
PK_QUALIFIED   = "SG.id"
PK_ALIAS       = "id_corretor"
CAMINHO_SQL    = caminho_sql("consulta_d_corretor")
