"""
Sincroniza f_descarte (origem bi_dommus -> destino dw_infratecnica.f_descarte).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em od.id_oportunidade_desistencia
        (alias id_descarte no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_descarte"
PK_QUALIFIED   = "od.id_oportunidade_desistencia"
PK_ALIAS       = "id_descarte"
CAMINHO_SQL    = caminho_sql("consulta_f_descarte")
