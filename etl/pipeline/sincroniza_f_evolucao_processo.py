"""
Sincroniza f_evolucao_processo (origem dommus_infratecnica.view_controle_sla_mais_recentes\n-> destino dw_infratecnica.f_evolucao_processo).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em m.id_midia
        (alias id_midia no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_evolucao_processo"
PK_QUALIFIED   = "e.id"
PK_ALIAS       = "id"
CAMINHO_SQL    = caminho_sql("consulta_f_evolucao_processo")
