"""
Sincroniza d_empreendimento (origem bi_dommus -> destino dw_infratecnica.d_empreendimento).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em e.id
        (alias id_empreendimento no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_empreendimento"
PK_QUALIFIED   = "e.id"
PK_ALIAS       = "id_empreendimento"
CAMINHO_SQL    = caminho_sql("consulta_d_empreendimento")
