"""
Sincroniza d_campanha (origem bi_dommus -> destino dw_infratecnica.d_campanha).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em c.id_campanha
        (alias id_campanha no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_campanha"
PK_QUALIFIED   = "c.id_campanha"
PK_ALIAS       = "id_campanha"
CAMINHO_SQL    = caminho_sql("consulta_d_campanha")
