"""
Sincroniza d_funil (origem bi_dommus -> destino dw_infratecnica.d_funil).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em f.id_funil
        (alias id_funil no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_funil"
PK_QUALIFIED   = "f.id_funil"
PK_ALIAS       = "id_funil"
CAMINHO_SQL    = caminho_sql("consulta_d_funil")
