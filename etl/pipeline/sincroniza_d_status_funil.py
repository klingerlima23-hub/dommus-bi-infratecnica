"""
Sincroniza d_status_funil (origem bi_dommus -> destino dw_infratecnica.d_status_funil).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em fso.id_funil_status_oportunidade
        (alias id_status_funil no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_status_funil"
PK_QUALIFIED   = "fso.id_funil_status_oportunidade"
PK_ALIAS       = "id_status_funil"
CAMINHO_SQL    = caminho_sql("consulta_d_status_funil")
