"""
Sincroniza d_fase_funil (origem bi_dommus -> destino dw_infratecnica.d_fase_funil).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em ff.id_fase_funil
        (alias id_fase_funil no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_fase_funil"
PK_QUALIFIED   = "ff.id_fase_funil"
PK_ALIAS       = "id_fase_funil"
CAMINHO_SQL    = caminho_sql("consulta_d_fase_funil")
