"""
Sincroniza d_etapa_oportunidade (origem bi_dommus -> destino dw_infratecnica.d_etapa_oportunidade).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em so.id_status_oportunidade
        (alias id_status_oportunidade no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_etapa_oportunidade"
PK_QUALIFIED   = "so.id_status_oportunidade"
PK_ALIAS       = "id_status_oportunidade"
CAMINHO_SQL    = caminho_sql("consulta_d_etapa_oportunidade")
