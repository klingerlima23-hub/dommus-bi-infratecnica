"""
Sincroniza d_midia (origem bi_dommus -> destino dw_infratecnica.d_midia).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_midia"
PK_QUALIFIED   = "m.id_midia"
PK_ALIAS       = "id_midia"
CAMINHO_SQL    = caminho_sql("consulta_d_midia")
