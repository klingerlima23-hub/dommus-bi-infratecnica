"""
Sincroniza d_origem (origem bi_dommus -> destino dw_infratecnica.d_origem).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em o.id_origem
        (alias id_origem no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_origem"
PK_QUALIFIED   = "o.id_origem"
PK_ALIAS       = "id_origem"
CAMINHO_SQL    = caminho_sql("consulta_d_origem")
