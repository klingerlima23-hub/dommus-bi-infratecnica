"""
Sincroniza d_fase_etapa (origem bi_dommus -> destino dw_infratecnica.d_fase_etapa).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em e.id
        (alias id_fase_etapa no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_fase_etapa"
PK_QUALIFIED   = "e.id"
PK_ALIAS       = "id_fase_etapa"
CAMINHO_SQL    = caminho_sql("consulta_d_fase_etapa")
