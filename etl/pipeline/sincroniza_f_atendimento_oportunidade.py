"""
Sincroniza f_atendimento_oportunidade (origem bi_dommus -> destino dw_infratecnica.f_atendimento_oportunidade).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em oa.id_oportunidade_atendimento
        (alias id_oportunidade_atendimento no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_atendimento_oportunidade"
PK_QUALIFIED   = "oa.id_oportunidade_atendimento"
PK_ALIAS       = "id_oportunidade_atendimento"
CAMINHO_SQL    = caminho_sql("consulta_f_atendimento_oportunidade")
