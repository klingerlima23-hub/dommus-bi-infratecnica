"""
Sincroniza f_distrato (origem bi_dommus -> destino dw_infratecnica.f_distrato).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em p.id
        (alias processo_id no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_distrato"
PK_QUALIFIED   = "p.id"
PK_ALIAS       = "processo_id"
CAMINHO_SQL    = caminho_sql("consulta_f_distrato")
