"""
Sincroniza d_usuario_gu (origem dommus_homolog_gu -> destino dw_infratecnica.d_usuario_gu).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em u.id
        (alias id_usuario_gu no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "d_usuario_gu"
PK_QUALIFIED   = "u.id"
PK_ALIAS       = "id_usuario_gu"
CAMINHO_SQL    = caminho_sql("consulta_d_usuario_gu")
