"""
Sincroniza f_lead (origem bi_dommus -> destino dw_infratecnica.f_lead).

Padrao: TRUNCATE + FULL LOAD com keyset pagination em l.id_lead
        (alias id_lead no resultado).
...
# ---------- parametros ----------
TABELA_DESTINO = "f_lead"
PK_QUALIFIED   = "l.id_lead"
PK_ALIAS       = "id_lead"
CAMINHO_SQL    = caminho_sql("consulta_f_lead")
